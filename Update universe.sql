...
INSERT INTO public.planet VALUES (3, 'neptunus', NULL, false, 1);
...
--
-- Name: galaxy name_unique_star; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: star name_unique_starr; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.star
    ADD CONSTRAINT name_unique_starr UNIQUE (name);
